  ...
  useEffect(() => {
    ...
    const loadAiData = async () => {
        ...
        try {
            ...
            // 2. Hospital Round
            // Mocking active patients in the ICU for the AI to analyze
            const activePatients = [
                {
                    ...
                    age: '8 anos',
                    diagnosis: 'Gastroenterite Hemorrágica',
                    admission_date: '2023-10-25T08:00:00',
                    vitals_history: [
                        { time: '08:00', hr: 100, rr: 24, temp: 38.5, mm: 'Rosadas', crt: '<2s', bp: '120/80' },
                        { time: '10:00', hr: 110, rr: 28, temp: 38.8, mm: 'Pálidas', crt: '2s', bp: '110/70' },
                        { time: '12:00', hr: 140, rr: 36, temp: 39.2, mm: 'Pálidas/Secas', crt: '3s', bp: '90/60' }
                    ]
                },
                {
                    id: '2',
                    ...
                    breed: 'Siamês',
                    age: '12 anos',
                    diagnosis: 'Insuficiência Renal Crônica (Agudização)',
                    admission_date: '2023-10-24T18:00:00',
                    vitals_history: [
                        { time: '08:00', hr: 180, rr: 30, temp: 37.8, urea: 150, crea: 3.5 },
                        { time: '12:00', hr: 175, rr: 28, temp: 38.0, urea: 145, crea: 3.4 }
                    ]
                }
            ];

            const round = await getHospitalizationRound(activePatients);
            ...
            <div className="space-y-1">
                ...
                <div className="flex items-center gap-2 mt-2">
                    <span className={`text-xs font-bold px-1.5 py-0.5 rounded ${
                        kpi.trend === 'down' ? 'bg-red-50 text-red-600 dark:bg-red-900/20' : 
